...
const ConfirmPopup = (props) => {
  const { open, setOpen, setAccepted, message, handleNo, yesBtn, noBtn, hideNoBtn } = props;
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                ...
                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  <button
                    type="button"
                    className="inline-flex w-full hover:bg-inherit justify-center rounded-3xl border border-transparent bg-purple-700 px-6 py-2 text-base font-medium text-white shadow-sm hover:bg-purple-500 focus:outline-none sm:ml-3 sm:w-auto sm:text-sm"
                    onClick={(e) => {
                      setOpen(false);
                      setAccepted(e);
                    }}
